 ...
 *
 * 类似于 LoginSuccesshandler、LoginFailHandler
 *
 *
 */
public class JwtLoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse resp)
        ...
        User user = new ObjectMapper().readValue(req.getInputStream(), UserInfo.class);
...
//                //配置用户角色
//                .setSubject(authResult.getName()).setExpiration(new Date(System.currentTimeMillis() + 10 * 60 * 1000))
//                .signWith(SignatureAlgorithm.HS512, "sang@123").compact();
